...
import group.pals.android.lib.ui.filechooser.utils.*;
...
public class FileChooserActivity extends Activity {
    ...
    private void setupService() {
        ...
        mFileProvider.setSortOrder(sortAscending ? SortOrder.Ascending : SortOrder.Descending);
    ...
    private void doShowCannotConnectToServiceAndFinish() {
        Dlg.showError(FileChooserActivity.this, R.string.afc_msg_cannot_connect_to_file_provider_service, new DialogInterface.OnCancelListener() {
    ...
    private static final int[] _BtnSortIds = {R.id.afc_settings_sort_view_button_sort_by_name_asc, R.id.afc_settings_sort_view_button_sort_by_name_desc, R.id.afc_settings_sort_view_button_sort_by_size_asc, R.id.afc_settings_sort_view_button_sort_by_size_desc, R.id.afc_settings_sort_view_button_sort_by_date_asc, R.id.afc_settings_sort_view_button_sort_by_date_desc};
    ...
    private void resortViewFiles() {
        if (mFileProvider.getSortType().equals(DisplayPrefs.getSortType(this)) && mFileProvider.getSortOrder().isAsc() == (DisplayPrefs.isSortAscending(this))) {
            return;
        }
    ...
    private void updateUI(IFile dir) {
        ...
        mBtnOk.setEnabled(isDirectoryWriteable || mFileProvider.getFilterMode() == FilterMode.AnyDirectories);
    }
    ...
    private final View.OnLongClickListener mBtnGoBackForwardOnLongClickListener = new View.OnLongClickListener() {
        ...
        @Override
        public boolean onLongClick(View v) {
            ViewFilesContextMenuUtils.doShowHistoryContents(FileChooserActivity.this, mFileProvider, mFullHistory, getLocation(), new TaskListener() {
        ...
        mListviewFilesGestureDetector = new GestureDetector(this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                if (mDoubleTapToChooseFiles) {
                    ...
                    if (data.getFile().isDirectory() && FilterMode.FilesOnly.equals(mFileProvider.getFilterMode())) {
                        return false;
                    }
    ...
    private final AdapterView.OnItemLongClickListener mViewFilesOnItemLongClickListener = new AdapterView.OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (mDoubleTapToChooseFiles) {
                ...
                if (!mIsSaveDialog && !mIsMultiSelection && data.getFile().isDirectory() && (FilterMode.DirectoriesOnly.equals(mFileProvider.getFilterMode()) || FilterMode.FilesAndDirectories.equals(mFileProvider.getFilterMode()))) {
                    doFinish(data.getFile());
                }
            }// single tap to choose files
