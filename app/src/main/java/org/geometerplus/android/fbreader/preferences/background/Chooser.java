...
public class Chooser extends ListActivity implements AdapterView.OnItemClickListener {
    ...
    private final AmbilWarnaDialog.OnAmbilWarnaListener myColorChooserListener = new AmbilWarnaDialog.OnAmbilWarnaListener() {
        @Override
        public void onOk(AmbilWarnaDialog dialog, int color) {
            final Intent result = new Intent().putExtra(BackgroundPreference.VALUE_KEY, "").putExtra(BackgroundPreference.COLOR_KEY, color);
